...
class NNOperationStateView: UIView {
...
//                let tipInfo = getAttString("请于12:32前到达T2地上停车场", textTaps: ["12:32","T2地上停车场"], tapColor: UIColor.red)
                let tipInfo = NSAttributedString.create("请于12:32前到达T2地上停车场", textTaps: ["12:32","T2地上停车场"], font: UIFont.systemFont(ofSize: 18), tapFont: UIFont.systemFont(ofSize: 18), color: .black, tapColor: UIColor.hex(topTitleColor), alignment: .center)
