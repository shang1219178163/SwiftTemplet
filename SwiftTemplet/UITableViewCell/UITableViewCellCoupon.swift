    ...
    override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey : Any]?, context: UnsafeMutableRawPointer?) {
        if keyPath == "text" {
            ...
            if value.contains(" ") == true {
                ...
                self.labelTop.attributedText = NSAttributedString.create(self.labelTop.text!, textTaps: [list.last!], font: UIFont.systemFont(ofSize: 22), tapFont: UIFont.systemFont(ofSize: 13), color: UIColor.white, tapColor: UIColor.hexValue(0xCADFFF), alignment: .center)
            }
