...
//    }
    ...
    lazy var list: [[[String]]] = {
        var array: [[[String]]] = [
            ...
            ["*发票类型".padRight(3), "UITableViewCellTextField", "50.0", "请输入收款人", "", ],
            ],
            [["发票详情", "UITableViewCellTitle", "50.0", "", "",],
            ["*抬头类型", "UITableViewCellSegment", "50.0", "", "", "公司,个人"],
            ["*发票抬头".padRight(3), "UITableViewCellTextField", "50.0", "请输入公司名称", "", ],
            ["*发票内容".padRight(3), "UITableViewCellTextField", "50.0", "请输入开票主体名称", "", ],
            ["*发票金额".padRight(3), "UITableViewCellTextField", "50.0", "请输入开票主体名称", "", ],
            ["*纳税人识别号".padRight(1), "UITableViewCellTextField", "50.0", "请输入纳税人识别号", "", ],
            ["更多信息(选填)", "UITableViewCellTextField", "50.0", "", "", ],
            ["注册地址".padRight(3), "UITableViewCellTextField", "50.0", "请输入注册地址", "", ],
            ["注册电话".padRight(3), "UITableViewCellTextField", "50.0", "请输入注册电话(11位)", "", ],
            ["开户银行".padRight(3), "UITableViewCellTextField", "50.0", "请输入开户银行", "", ],
            ["银行帐号".padRight(3), "UITableViewCellTextField", "50.0", "请输入银行账号", "", ],
            ],
            [["*收件人".padRight(3), "UITableViewCellTextField", "50.0", "请输入收件人名称", "", ],
             ["*收件地址".padRight(2), "UITableViewCellTextField", "50.0", "请输入收件地址", "", ],
            ["*联系方式".padRight(2), "UITableViewCellTextField", "50.0", "请输入联系人手机号(11位数字)", "", ],
            ],
        ]
        return array
    }()
