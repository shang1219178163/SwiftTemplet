...
@objcMembers class NNUserLevelInfoView: UIView {
    ...
    func updateLevelDesc() {
        ...
        let attString = NSAttributedString.create(text, textTaps: taps, font: UIFont.systemFont(ofSize: 12), tapFont: UIFont.systemFont(ofSize: 12), color: UIColor.hexValue(0x7F808F), tapColor: UIColor.hexValue(0xF0C09B), alignment: .left)
