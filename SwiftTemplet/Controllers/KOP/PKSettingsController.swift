...
//        """
    ...
    lazy var list: [[[String]]] = {
        var array: [[[String]]] = [
            [["个人资料", "UITableViewCellTitle", "50.0", "", "PKUserInfoEditController",],
            ["账号与安全", "UITableViewCellTextField", "50.0", "", "PKAccountAboutController", ],
            ],
            [["推荐给好友", "UITableViewCellTextField", "50.0", "", "", ],
            ["反馈与建议", "UITableViewCellTextField", "50.0", "", "PKFeedBackController", ],
            ["去应用市场好评", "UITableViewCellTextField", "50.0", "", "APPStore", ],
            ],
            [["关于应用", "UITableViewCellTextField", "50.0", "", "seller_bank_account", ],
            ],
            [["退出当前帐号", "UITableViewCellButton", "50.0", "", "seller_bank_account", ],
            ],
...
extension PKSettingsController: UITableViewDataSource, UITableViewDelegate{
    //    MARK: - tableView
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case "UITableViewCellButton":
            ...
            cell.btn.setTitle(value0, for: .normal)
