...
class NNChooseCityController: UIViewController {
    ...
    lazy var viewModel: NNAddressPickerViewModel = {
        ...
        viewModel.districtApi.leveltype = "2"
    ...
    func requestList() {
        ...
        viewModel.requestList { (list) in
            ...
            if self.parentVC.thirdVC.parentModel == nil {
                self.parentVC.thirdVC.parentModel = self.dataModel
            }
...
extension NNChooseCityController: UITableViewDataSource, UITableViewDelegate {
    //    MARK: - tableView
...
//        cell.getViewLayer()
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        parentVC.thirdVC.parentModel = model
        parentVC.selectedIndex = 2;
        
        parentVC.secondVC.title = model.label
